 ...
 * @author plantc59cs
 */
public class EdgeUpdateThread implements Callable {
...
//        p.locks[Math.max(edge.getFirst(), edge.getSecond())].lock();
        ...
        //This is required for random edge sampling
//        if(formerNonEdge1!=p.vNonEdge1[i]||formerNonEdge2!=p.vNonEdge2[i]){
...
//            return;
//        }
//required for random edge sampling
