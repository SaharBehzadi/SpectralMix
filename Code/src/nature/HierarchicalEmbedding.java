...
public class HierarchicalEmbedding {
    ...
    public HierarchicalEmbedding(Graph g, double seedPercentage) {
        this.g = g;
        GraphClustering gc = new GraphClustering(g, seedPercentage, 61);
        gc.run();
        red = gc.getRed();
        ...
        for (int i = 0; i < numLevels; i++) {
            ...
            for (int j = 0; j < pointIdToNodename[i].size(); j++) {
                rel.addVertex(j);
//                relabeledNodeWeights[i][j] = nodeWeights[i][nodenameToPointId[i].get(j)];
            }
...
//       // 3D///////////////////////////////////////////////////////////////////////////////
        ...
        du.saveAsMatlab(cRes, "coord", "result3d.mat");
    }
