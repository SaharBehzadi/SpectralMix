 ...
 */
public class ActiveStochasticGDDispl extends AbstractLayout<Integer, Integer> implements IterativeContext {
    ...
    public ActiveStochasticGDDispl(Graph<Integer, Integer> g) {
        super(g);
        this.g = g;
        r = new Random(20);
        //this.factor = factor;
    ...
    public ActiveStochasticGDDispl(Graph<Integer, Integer> g, double factor) {
        super(g);
        r = new Random(20);
        n = g.getVertexCount();
        m = n * (n - 1) / 2;
