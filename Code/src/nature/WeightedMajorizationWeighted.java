 ...
 */
public class WeightedMajorizationWeighted {
    ...
    public WeightedMajorizationWeighted() {
    }
    ...
    public WeightedMajorizationWeighted(Graph g, int d, double maxSigma, double[] nodeWeights, double[] edgeMultiplicity) {
        this.g = g;
        this.d = d;
    ...
    public WeightedMajorizationWeighted(Graph g, int d, double maxSigma, double[][] groundTruth) {
        this.g = g;
        this.d = d;
    ...
    public void run(double convConst) {
        ...
        while ((!converged || currentIteration < 50) && currentIteration < maxIteration) {
            //while (!converged) {
            //DEBUG
...
//                    }
    ...
    void run(double[][] coord, double convConstant) {
       this.coord = coord;
       run(convConstant);
    }
